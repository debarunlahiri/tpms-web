            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php if (empty($deals)): ?>
                            <tr><td colspan="7" class="px-6 py-12 text-center text-gray-500">No deals found. <a href="deals.php?action=add" class="text-primary-600 hover:underline">Create your first deal</a>.</td></tr>
                        <?php else: ?>

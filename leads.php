                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php if (empty($leads)): ?>
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center text-gray-500">No leads found. <a href="leads.php?action=add" class="text-primary-600 hover:underline">Create your first lead</a>.</td>
                                </tr>
                            <?php else: ?>
